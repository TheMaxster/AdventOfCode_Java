...
public class Day09Test {
    ...
    private static final String SRC_FILE = "src/main/resources/year2024/day09/input.txt";
    ...
    void testPart1() {
        ...
        Assertions.assertEquals("6446899523367", result);
    }

    @Test
    void testPart2() {
        final String result = DAY.part2(INPUT_FILE);
        Assertions.assertEquals("6478232739671", result);
    }
}
