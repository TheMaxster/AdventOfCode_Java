...
public class Day15Test {
    ...
    private static final String SRC_FILE = "src/main/resources/year2024/day15/input.txt";
    ...
    void testPart1() {
        ...
        Assertions.assertEquals("1563092", result);
    }

    @Test
    void testPart2() {
        final String result = DAY.part2(INPUT_FILE);
        Assertions.assertEquals("1582688", result);
    }
}
