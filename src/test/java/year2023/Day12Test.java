...
public class Day12Test {
    ...
    private static final String SRC_FILE = "src/main/resources/year2023/day12/input.txt";
    ...
    void testPart1() {
        ...
        Assertions.assertEquals("7490", result);
    }

    @Test
    void testPart2() {
        final String result = DAY.part2(INPUT_FILE);
        Assertions.assertEquals("65607131946466", result);
    }
}
