...
public class Day16Test {
    ...
    private static final String SRC_FILE = "src/main/resources/year2023/day16/input.txt";
    ...
    void testPart1() {
        ...
        Assertions.assertEquals("8098", result);
    }

    @Test
    void testPart2() {
        final String result = DAY.part2(INPUT_FILE);
        Assertions.assertEquals("8335", result);
    }
}
