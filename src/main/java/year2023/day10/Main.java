//package main.java.year2023.day10;
//
...
//        //         final String filePath = System.getProperty("user.dir") + "/resources/main.resources.year2023/day10/input_test_01.txt";
//        //      final String filePath = System.getProperty("user.dir") + "/resources/main.resources.year2023/day10/input_test_02.txt";
//        //  final String filePath = System.getProperty("user.dir") + "/resources/main.resources.year2023/day10/input_test_02_01.txt";
//        //  final String filePath = System.getProperty("user.dir") + "/resources/main.resources.year2023/day10/input_test_02_02.txt";
//        //final String filePath = System.getProperty("user.dir") + "/resources/main.resources.year2023/day10/input_test_02_03.txt";
//        // final String filePath = System.getProperty("user.dir") + "/resources/main.resources.year2023/day10/input_test_02_04.txt";
//        final String filePath = System.getProperty("user.dir") + "/resources/main.resources.year2023/day10/input.txt";
//
...
//        ArrayUtils.log("Start is: " + start.toString());
//
//        final Set<Coordinate> visited = goFurther(start, part1Map);
//
//        final long validVisits = visited.stream().filter(Coordinate::valid).count();
//
//        ArrayUtils.log("Solution Part 1: We run in the circle with nodes: " + validVisits);
//        ArrayUtils.log("So the farthest part is the half: " + validVisits / 2);
//
//        // ---------------------------------------------------------------------------------------------------------------
...
//        ArrayUtils.log("Solution Part 2: Found inner tiles: " + innerInvalidVisits.size());
//
//    }
//
...
//                        ArrayUtils.log(innerInvalidVisit.toString());
//                    }
//                }
//            }
//        }
...
//
//            ArrayUtils.log(current.toString() + " : " + visited.contains(current));
//
