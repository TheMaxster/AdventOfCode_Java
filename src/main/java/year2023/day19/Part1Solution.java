//package main.java.year2023.day19;
//
...
//        final String filePath = System.getProperty("user.dir") + "/resources/main.resources.year2023/day19/input.txt";
//
...
//            ArrayUtils.log(entry.getKey() + " " + entry.getValue().toString());
//        }
//
...
//        ArrayUtils.log("Total sum: " + totalSum);
//    }
//
...
//    ) {
//        ArrayUtils.log(part + " -> " + rule.consequence);
