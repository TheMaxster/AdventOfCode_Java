//package main.java.year2023.day20;
//
...
//
//                ArrayUtils.log("send " + currentElement.pulse() + " to " + currentModule.getUid());
//
...
//        }
//
//        ArrayUtils.log("Low Pulses: " + lowPulses);
//        ArrayUtils.log("High Pulses: " + highPulses);
//        ArrayUtils.log("Solution for Part 1: Product: " + lowPulses * highPulses);
//        ArrayUtils.log(" ");
//        ArrayUtils.log("Solution for Part 2: " + lastIncomingWasHigh.toString());
