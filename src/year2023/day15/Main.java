...
public class Main {
    ...
    public static void main(final String[] args) {
        // final String filePath = System.getProperty("user.dir") + "/resources/year2023/day15/input_test_01_01.txt";
        //final String filePath = System.getProperty("user.dir") + "/resources/year2023/day15/input_test_01_02.txt";
        final String filePath = System.getProperty("user.dir") + "/resources/year2023/day15/input.txt";
    ...
    private static void calculatePart1(final List<String> steps) {
        ...
        final int sumOfCurrentValues = Utils.sumUp(currentValues);
